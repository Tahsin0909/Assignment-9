...
const AboutUs = () => {
    return (
        <div className="relative top-24 md:top-28 mb-32 mx-4 lg:mb-40 lg:mx-20 lg:pl-10">
            <img className="w-full" src="https://a.storyblok.com/f/42908/1200x601/399b368e9c/gc-team-images-1200px.jpg" alt="" />
            <div>
                <p className="lg:text-3xl text-2xl font-semibold text-blue-600 lg:mt-4">Welcome to Elysian EventManagement Ltd. - Your Event Experience Architects</p>
            ...
            <div>
                <p className="lg:text-3xl text-2xl font-semibold text-blue-600 lg:mt-4" >Our Approach</p>
            ...
            <div>
                <p className="lg:text-3xl text-2xl font-semibold text-blue-600 lg:mt-4" >Our Commitment</p>
            ...
            <div>
                <p className="lg:text-3xl text-2xl font-semibold text-blue-600 lg:mt-4" >Get in Touch</p>
